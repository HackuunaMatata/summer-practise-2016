...
/**
 * Class for description user's event. <br> Every event has unique text message with description of event's reason and
 * date when text message needs to be displayed.
 */
public class Event
{
   ...
   /**
    * DESC: clean event or other words set date 0.
    */
   public void clean ()
   {
      this.date.setTime(0);
