...
public class AddItemServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (object.checkUniqueQuestion(eventId, itemname)){
                object.addQuestiontoDB(eventId, itemname, tagAndType[0], tagAndType[1],desc, answers);
                out.println("<!DOCTYPE html>");
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Добавлено</title>");            
                out.println("</head>");
                out.println("<body>");
                out.println("<h1> Пункт " + itemname+" добавлен успешно</h1>");
                ...
                out.println("</head>");
                out.println("<body>");
                out.println("<h1> Пункт " + itemname+" существует для мероприятия "+eventId+"</h1>");
                out.println("<p><a href=\"formview.html?event="+eventId+
                        "-"+object.getEventTitle(eventId)+
                        "\"><-Обратно</a></p>");
                out.println("</body>");
