...
/**
 * BlobsId generated by hbm2java
 */
@Embeddable
public class BlobsId  implements java.io.Serializable {
    ...
    public BlobsId(int iduser, int iditem, int idevent) {
       this.iduser = iduser;
       this.iditem = iditem;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof BlobsId) ) return false;
		 BlobsId castOther = ( BlobsId ) other; 
